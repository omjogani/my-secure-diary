...
class InternetMonitorService {
  StreamController<InternetConnectivityStatus>
  ...
  InternetMonitorService() {
    Connectivity()
      ...
      internetConnectionStatusController
          .add(await _getStatusFromResult(result));
    });
  }
}
...
Future<InternetConnectivityStatus> _getStatusFromResult(
    ConnectivityResult result) async {
  switch (result) {
    case ConnectivityResult.mobile:
      return await checkOriginalInternetConnection()
          ? InternetConnectivityStatus.mobileData
